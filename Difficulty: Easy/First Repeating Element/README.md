<h2><a href="https://www.geeksforgeeks.org/problems/first-repeating-element4018/1?page=1&category=Arrays,Strings,Tree,Hash,Linked%20List,Stack,Binary%20Search%20Tree,Binary%20Search,Queue,Map,palindrome,Fibonacci,Traversal,set&difficulty=Basic&status=unsolved&sortBy=submissions">First Repeating Element</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array arr[], find the first repeating element. The element should occur more than once and the index of its first occurrence should be the smallest.</span></p>
