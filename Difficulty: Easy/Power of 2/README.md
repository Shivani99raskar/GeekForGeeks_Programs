<h2><a href="https://www.geeksforgeeks.org/problems/power-of-2-1587115620/1?page=1&category=Data%20Structures,Algorithms,Arrays,Strings,Tree,Hash,Graph,Linked%20List,Greedy,Stack,Recursion,Binary%20Search%20Tree,Binary%20Search,BFS,Queue,Map,palindrome,Traversal,Java-Collections,OOP,set&difficulty=Basic,Easy&status=unsolved&sortBy=submissions">Power of 2</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a non-negative integer <strong>n</strong>. The task is to check if it is a power of <strong>2</strong>.&nbsp; <br></span></p>
